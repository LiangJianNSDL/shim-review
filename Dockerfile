...
#RUN wget https://github.com/LiangJianNSDL/shim-review/blob/nsdl-v4-shim/shim-unsigned-x64-15.5-1.el8.src.rpm
COPY shim-unsigned-x64-15.5-1.el8.src.rpm ./
...
RUN sha256sum ./usr/share/shim/15.5-1.el8/x64/shimx64.efi ./usr/share/shim/15.5-1.el8/ia32/shimia32.efi /shimia32.efi /shimx64.efi
...
RUN cmp ./usr/share/shim/15.5-1.el8/x64/shimx64.efi /shimx64.efi
RUN cmp ./usr/share/shim/15.5-1.el8/ia32/shimia32.efi /shimia32.efi
